...
<body>
    ...
    <?php $this->load->view("TS/installs/add/adddevice");?>
    <?php $this->load->view("TS/installs/add/addphiloin");?>
    <?php $this->load->view("TS/installs/add/addvas");?>
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table images gambar" id="install_image">
                            ...
                            <tbody>
                                ...
                                <tr class="rImage" image_id='<?php echo $image->id;?>' >
                                    <?php if($image->imgondisk==="1"){?>
                                        <td class="image_path">
                                            <a class="fancyboxx" rel="group">
                                                <img src="/images/installs/<?php echo $image->path;?>" 
                                                class="img-polaroid" onclick="viewImage(this)" width=50 height=38 />
                                            </a>
                                    </td>
                                    <?php }else{?>
                                    <td class="image_path">
