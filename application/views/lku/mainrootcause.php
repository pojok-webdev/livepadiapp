<html>
	...
	<body>
		<div class="container">
		<div class="jumbotron">
		<h3>Laporan Main RootCause TS</h3>
		<h3><?php echo $date1 . ' - ' . $date2;?> (<?php echo $total;?> ticket)</h3>
		<h5>
		...
		<input type="text" class="monthdatepicker" id="reportdate2" value ="<?php echo $dateselected2;?>">
			...
			<a href="<?php echo base_url()?>lku" class="btn btn-success">Home</a>
		</h5>
		</div>
		<div class="row">
			...
			(function($){
				...
				$("#btnfilter").click(function(){
					...
					if($("#reportdate1").val().trim()!==""){
						...
						window.location.href = "/lku/mainrootcause/"+dt1+"/"+mn1+"/"+yr1+"/"+dt2+"/"+mn2+"/"+yr2+"/"+branch+"/"+category;
					}
				})
