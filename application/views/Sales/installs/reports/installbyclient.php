...
<div class="container" id="fromHTMLtestdiv">
	...
	<div class="row barow">
		<div class="row">
		<?php if($tj->imgondisk==="1"){?>
			<div class="col-md-12"><img class="img-responsive padbot10" src="/images/installs/<?php echo $tj->path;?>"  width=1600 height=1200 /></div>
			<?php }else{?>
	...
	<?php if($ka->imgondisk==="1"){?>
		<div class="col-md-12"><img class="img-responsive padbot10" src="/images/installs/<?php echo $ka->path;?>"  width=1600 height=1200 /></div>
			<?php }else{?>
	...
	<div class="row barow">
		...
		<?php if($wr->imgondisk==="1"){?>
			<div class="col-md-12"><img class="img-responsive padbot10" src="/images/installs/<?php echo $wr->path;?>"  width=1600 height=1200 /></div>
			<?php }else{?>
	...
	<div class="row padbot10 barow">
		...
		<?php if($st->imgondisk==="1"){?>
				<div class="col-md-12"><img class="img-responsive padbot10" src="/images/installs/<?php echo $st->path;?>"  width=1600 height=1200 /></div>
			<?php }else{?>
	...
	<div class="row padbot10 barow">
		<div class="row">
		<div class="col-md-12">
			<?php if($df->imgondisk==="1"){?>
				<img class="img-responsive padbot10" src="/images/installs/<?php echo $df->path;?>"  width=1600 height=1200 />
			<?php }else{?>
	...
	<div class="row padbot50">
		<div class="col-md-12">
			...
			<?php foreach($services as $service){?>
				<?php $c++;?>
				<?php echo $c . '. ' . $service->servicetype . ' - ' . $service->servicename . '<br />';?>
			<?php }?>
		</div>
	</div>
