...
//        return array();
        $params = $this->input->post();
        echo json_encode($this->pfbs->getproducts($params));
    }
    function edit(){
        $this->common->check_login();
		$data['dt1']='2016-1-1';
        ...
        if($clientsite!=false){
            ...
            $vas = new Vas();
            $service = $pfbs->getservices($nofb);
            $devices = $pfbs->getdevicesbynofb($nofb);
            $fbvas =$pfbs->getfbvas($nofb);
            $getvases = $pfbs->getvases($nofb);
            $documents = $this->pfbs->getdocumentarray();
            $fbdocuments = $pfbs->getdocuments($nofb);
            $documentstatus = array();
    ...
    function removedevice(){
        $params = $this->input->post();
        $pfbs = new Pfbs();
        $pfbs->removedevice($params);
    }
    function removevas(){
        $params = $this->input->post();
        $pfbs = new Pfbs();
        echo $pfbs->removevas($params);
    }
    function backupfb(){
        $nofb = $this->uri->segment(3);
    ...
    function saveproduct(){
        $params = $this->input->post();
        echo $this->pfbs->saveproduct($params);
    }
...
//        echo $params['data'];
    ...
    function savefbvas(){
        $params = $this->input->post();
        $pfbs = new Pfbs();
        echo json_encode($pfbs->savefbvas($params));
    }
	function showreport(){
        $this->common->check_login();
		$data['dt1']='2016-1-1';
