			...
			$.ajax({
				...
				success:function(){
					...
					$.ajax({
						url:'/applogs/create',
						data:{
							subject:'Admin Suspend Client',
							description:'id: '+myid+' ,name: '+clientname,
							user:$('#createuser').val()
						},
						type:'post'
					})
					.done(res=>{
						console.log('Success add log',res)
					})
					.fail(err=>{
						console.log('Failed add log',err)
					})
				},
				error:function(err){
					console.log('err',err);
			...
			.done(function(){
				...
				.done(function(res){
					...
					$.ajax({
						url:'/applogs/create',
						data:{
							subject:'Admin Remove Client',
							description:'id: '+clientid+' ,name: '+clientname,
							user:$('#createuser').val()
						},
						type:'post'
					})
	...
	$('#changeclientaliasmodal').click(function(){
		...
		.done(function(res){
			...
			$.ajax({
				url:'/applogs/create',
				data:{
					subject:'Admin Change Name/Alias',
					description:'id: '+$('#tClient tr.selected').attr('myid')+' ,name: '+$('#name').val()+' ,Alias: '+$('#alias').val(),
					user:$('#createuser').val()
				},
				type:'post'
			})
